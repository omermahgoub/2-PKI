<#
    ...
    .EXAMPLE
    Install-ADCSRootCA.ps1 -Company contoso -DomainURL pki.contoso.com -ConfigNC 'CN=Configuration,DC=contoso,DC=lab'
    ...
    The PKI folder contains the Database and paths for AIA and CRL.
    .NOTES
    Created on:     2018-09-03 017:03
    Created by:     Omer Mahgoub Hamad
    Organization:   vmland.wordpress.com
    Filename:       Install-ADCSRootCA.ps1
    Version:        1.0
    Requirements:   Powershell 4.0 (Module: ServerManager)
    Changelog:      2018-09-03 017:03 - Creation of initial script
                    ...
                    2018-09-03 017:03 - Minor bugfixes and corrections based on PSSharper.
                    2018-09-03 017:03 - Correction of typos. Clean up help text.
    .LINK
...
process
{
    if ($PSCmdlet.ShouldProcess("$($Company)($($DomainURL)) - $($LocalPKIPath)",'Configure Offline Root CA'))
    {
